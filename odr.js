window.addEventListener('load', function () {
    ...
    function callWebService() {
        ...
        jQuery.ajax({
            url: "https://buzko-test.azure-api.net/predict/execute?api-version=2.0&details=true",
            beforeSend: function (xhrObj) {
                xhrObj.setRequestHeader("Content-Type", "application/json;charset=utf-8");
                xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key", "760b6e25c3ef46a580da282cfca311bd");
